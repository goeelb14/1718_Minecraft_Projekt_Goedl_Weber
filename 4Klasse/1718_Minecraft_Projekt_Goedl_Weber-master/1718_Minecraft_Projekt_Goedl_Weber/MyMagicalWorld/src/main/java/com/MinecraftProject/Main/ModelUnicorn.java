...
import net.minecraft.util.math.MathHelper;
    ...
    public class ModelUnicorn extends net.minecraft.client.model.ModelHorse
    {
        public final ModelRenderer Horn;
        ...
        public ModelUnicorn()
        {
            ...
            Horn= new ModelRenderer(this,0,70);

            this.Horn.addBox(-0.5f, -9.5f, -1.5F, 1, 5, 1);
            this.head.setRotationPoint(0.0F, 4.0F, -10.0F);
