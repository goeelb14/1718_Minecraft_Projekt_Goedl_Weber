...
public class ModelPegasus  extends ModelHorse
{
    ...
    public ModelPegasus()
    {
        ...
        LeftWing= new ModelRenderer(this,0,70);

        this.body.addBox(-0.5f, -9.5f, 1.5F, 1, 5, 1);
        //this.body.setRotationPoint(0.0F, 4.0F, -10.0F);
        this.setBoxRotation(this.LeftWing, 0.5235988F, 0.0F, 0.0F);
        this.head.addChild(LeftWing);
        RightWing= new ModelRenderer(this,0,70);

        this.body.addBox(0.5f, 0f, 1.5F, 1, 5, 1);
        //this.body.setRotationPoint(0.0F, 4.0F, -10.0F);
        this.setBoxRotation(this.RightWing, 0.5235988F, 0.0F, 0.0F);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        LeftWing.rotateAngleY=body.rotateAngleY;
        RightWing.rotateAngleX=body.rotateAngleX;
        RightWing.rotateAngleY=body.rotateAngleY;
    }

    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        EntityUnicorn entityhorse = (EntityUnicorn)entityIn;
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
    {
        ...
        EntityUnicorn entityhorse = (EntityUnicorn)entitylivingbaseIn;
